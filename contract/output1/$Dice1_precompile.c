...
UNMUTABLE
string GetNickName() {
key8k69e4ms(); return GetNickNameFromAddress(GetSender()); }

UNMUTABLE
address GetOwner() {
key8k69e4ms(); return owner; }
...
UNMUTABLE
uint256 GetAmount() {
key8k69e4ms(); return GetAmountFromAddress(GetSender()); }
...
key8k69e4ms(); return totalGameCount; }
